...
<cfif HGetTotPlays.totplays is 0>
	...
	<cfhttp method='post'
		...
		<cfhttpparam name='mySubject' type='FormField' value="Error:LastSevenHealthWithNFLSched.cfm">
...
<cfquery datasource="Nba" name="GetStatus">
	...
	values('#Gametime#','TEAMHEALTHLast7')
</cfquery>
...
<cfcatch type="any">
	...
	<cfhttp method='post'
		...
		<cfhttpparam name='mySubject' type='FormField' value="Error:LastSevenHealthWithSched.cfm">
		<cfhttpparam name='myCC'      type='FormField' value="jmcguin1@nycap.rr.com">
	</cfhttp>
