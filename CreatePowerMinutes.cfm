...
Checking:<br>
AVG: #GetFavOppAvg.ofgpct1#  Actual:#GetFAVResults.dfgpct#<br>
...
<cfquery datasource="Nba" name="UpdStatus">
	Insert into NBADataloadStatus(StepName) values('Done-CreatePowerMinutes.cfm')
</cfquery>