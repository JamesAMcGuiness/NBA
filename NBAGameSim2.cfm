...
<cfset oFavRebPct = #GetFavPcts.oRebPct#>
<cfset oFavDRebPct = #GetFavPcts.DRebPct#>
...
<cfset oUndRebPct = #GetUndPcts.oRebPct#>
<cfset oUndDRebPct = #GetUndPcts.DRebPct#>
...
<cfset dFavRebPct = #GetFavPcts.oRebPct#>
<cfset dFavDRebPct = #GetFavPcts.dRebPct#>
...
<cfset dUndRebPct = #GetUndPcts.oRebPct#>
<cfset dUndDRebPct = #GetUndPcts.dRebPct#>
...
<cfset FavPredTurnovpct = (oFavTopct + dUndTopct)/2>
<cfset FavPredFouledpct = (oFavFouled + dUndFouled)/2>

<cfset FavPredOffRebpct = (oFavRebPct + dUndRebpct)/2>
<cfset FavPredDefRebpct = (oFavDRebPct + dUndDRebpct)/2>
...
<cfset UndPredTurnovpct = (oUndTopct + dFavTopct)/2>
<cfset UndPredFouledpct = (oUndFouled + dFavFouled)/2>

<cfset UndPredOffRebpct = (oUndRebPct + dFavRebpct)/2>
<cfset UndPredDefRebpct = (oUndDRebPct + dFavDRebpct)/2>
...
<!-- 3pt Att -->
<cfset FavPlayTpAttNum   = FavPlayFGAttNum + 1> 

<!-- Turnover -->
<cfset FavPlayTurnoverNum   = (FavPredTurnovPct*100)> 
<cfset FavPredFTPoints = ((#FavPredFouledPct#)*#FavPredPos#)*(#FavPredFTSuccess#/100)>

<cfoutput>
FavPlayFGAttNum = #FavPlayFGAttNum#<br>
FavPlayTpAttNum = #FavPlayTpAttNum#<br>
FavPlayTurnoverNum = #FavPlayTurnoverNum#<br>
FavPredFouledPct   = #FavPredFouledPct#<br>
FavPredOffRebpct = #FavPredOffRebpct#<br>
FavPredDefRebpct = #FavPredDefRebpct#<br>
FavFTPoints = #FavPredFTPoints#<br>
============================================================================<br><br>
</cfoutput>
...
<!-- 3pt Att -->
<cfset UndPlayTpAttNum   = UndPlayFGAttNum + 1> 

<!-- Turnover -->
<cfset UndPlayTurnoverNum   = (UndPredTurnovPct*100)> 

<cfset UndPredFTPoints = ((#UndPredFouledPct#)*#UndPredPos#)*(#UndPredFTSuccess#/100)>

<cfoutput>
UndPlayFGAttNum = #UndPlayFGAttNum#<br>
UndPlayTpAttNum = #UndPlayTpAttNum#<br>
UndPlayTurnoverNum = #UndPlayTurnoverNum#<br>
UndPredFouledPct   = #UndPredFouledPct#<br>
UndPredOffRebpct = #UndPredOffRebpct#<br>
UndPredDefRebpct = #UndPredDefRebpct#<br>
UndFTPoints = #UndPredFTPoints#<br>
============================================================================<br><br>
</cfoutput>

<cfset FavDriveTotal    =(FavPredPos)>
<cfset UndDriveTotal    =(UndPredPos)> 
...
<!--- 		<cfoutput>
 ...
 --->		
		<cfif possesion is '#fav#'>
			<cfset checkpct = FavPlayTurnoverNum>
			<cfset checkrebound = FavPredOffRebPct>
		<cfelse>	
			<cfset checkpct = UndPlayTurnoverNum>
			<cfset checkrebound = UndPredOffRebPct>
		</cfif>
		
		<!-- Regular possesion -->
		<cfif checkForTurnover(RN,checkpct) is 'N'>
			<cfoutput>
			<!--- Regular possesion..rn is #rn#..Checkpct is #checkpct#.....#FavPlayFGAttNum#......#FavPlayTpAttNum#.............................................<br> --->
			</cfoutput>		
			<!--- See what type of possesion it is... --->
			<cfoutput>Possesion is for #Possesion#............<br></cfoutput>
			<cfif possesion is '#fav#'>
				<Cfset PossesionType = getPossesionType(RN,FavPlayFGAttNum,FavPlayTpAttNum,0)>
			<cfelse>
				<Cfset PossesionType = getPossesionType(Rn,UndPlayFGAttNum,UndPlayTpAttNum,0)>
			</cfif>
			...
			<cfelse>
				...
				<cfif PossesionType is '2ptFGAtt' or  PossesionType is '3ptFGAtt'>
					...
					<cfif GotTheRebound(rn,(checkrebound*100)) is 'Y'>
						*******Got the rebound!<br>
...
<!--- 		<cfoutput>
 ...
 --->		
	...
	<cfelse>
		<cfoutput>
		We have us a turnover!!!!!!!!!!!!!!!! for #possesion#...<br>	
<!--- 		<cfif possesion is '#fav#'>
			<cfset FavDriveCt = FavDriveCt - 1>
		<cfelse>
			<cfset UndDriveCt = UndDriveCt - 1>
...
<!--- 		<cfoutput>
 ...
 --->		
 	...
 	<cfset  FavScore = FavScore + FavPredFTPoints>
	<cfset  UndScore = UndScore + UndPredFTPoints>
