...
<!--  						<cfoutput>
						#TheWorseteam# is #HowMuchWorse# worse on Offense, since #TheOppfgpct# was scored than we will store the lower #ValueToSave#<br>
						</cfoutput>
 -->
						<!-- Save Matrix row -->	
...
<!-- 						<cfoutput>
						#TheBetterteam# is #HowMuchBetter# better on Offense, since #TheOppfgpct# was scored than we will store the higher amount #ValueToSave#<br>
						</cfoutput>
 -->
	 					<!-- Save Matrix row -->	
						<cfquery datasource="nba" name="addit">
...
<!-- 						<cfoutput>
						#thesameteam# is rated the same, since #TheOppfgpct# was scored than we will store the same value #ValueToSave#<br>
						</cfoutput>
 -->						<!-- Save Matrix row -->	
												<!-- Save Matrix row -->	
					 	<cfquery datasource="nba" name="addit">
...
<cfcatch type="any">
	...
	<cfhttp method='post'
		...
		<cfhttpparam name='mySubject' type='FormField' value="Error:LoadMatrixFGPctHome.cfm">
