...
<cfquery datasource="nba" name="InserAVGS">
			Delete from PBPAVGS
		</cfquery>
...
select 
	...
	o.HA,
	o.OffDef,
	AVG(o.TotalPossesions)    as aoTotPoss,
	...
	AVG(o.gs3ptMakePct)        as aoLongMake
	
	
from PBPAvgPctsHA o 
group by o.team, o.HA, o.OffDef
order by o.Team, o.HA, o.OffDef
</cfquery>	

<cfloop query="GetAVGS">
	
		<cfquery datasource="nba" name="InserAVGS">
			INSERT INTO PBPAVGS(Team,HA,OffDef,Possesions,gs2ptshortmakepct,gs2ptmidmakepct,gs2ptmakepct,gsFTMakePct,gsTurnoverPct,OffReb,gs3ptMakePct)
			VALUES ('#Team#','#HA#','#OFFDEF#',#aoTotPoss#,#aoShortMake#,#aoMidMake#,#ao2ptmake#,#aoFTMake#,#aoTurnover#,#aOffReb#,#aoLongMake#)
		</cfquery>
...
<!--- Create Power Ratings For Each Game Played --->
