...
<cfset FavDCOff  = myPBPCFC.getDriveInfo('O','#Fav#','#FavHA#')>
<cfset UndDCOff  = myPBPCFC.getDriveInfo('O','#Und#','#UndHA#')>

<cfset FavDCDef  = myPBPCFC.getDriveInfo('D','#Fav#','#FavHA#')>
<cfset UndDCDef  = myPBPCFC.getDriveInfo('D','#Und#','#UndHA#')>
...
<cfquery datasource="NBA" name="GetFavPossOff">
Select Avg(ofga) + Avg(oturnovers) + Avg(dturnovers) + Avg(oFTA) + Avg(oReb)  as oPoss 
From NBAData
Where Team = '#Games.fav#'
</cfquery>

<cfquery datasource="NBA" name="GetFavPossDef">
Select .96*( (Avg(dfga) + Avg(dturnovers)) + .44 * (Avg(dFTA) - Avg(dReb) )  ) as dPoss 
From NBAData
Where Team = '#Games.fav#'
</cfquery>

<cfquery datasource="NBA" name="GetUndPossOff">
Select Avg(ofga) + Avg(oturnovers) + Avg(dturnovers) + Avg(oFTA) + Avg(oReb)  as oPoss 
From NBAData
Where Team = '#Games.und#'
</cfquery>

<cfquery datasource="NBA" name="GetUndPossDef">
Select .96*( (Avg(dfga) + Avg(dturnovers)) + .44 * (Avg(dFTA) - Avg(dReb) )  ) as dPoss 
From NBAData
Where Team = '#Games.Und#'
</cfquery>

<cfset PossessionPrediction = (GetFavPossOff.oPoss + GetUndPossOff.oPoss)/2 >
<cfset FavTotPoss = GetFavPossOff.oPoss>
<cfset UndTotPoss = GetUndPossOff.oPoss>


<cfoutput>
The predicted number of possessions is #PossessionPrediction#
</cfoutput>
