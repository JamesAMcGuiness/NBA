...
<cfset done = false>
<cfset FoundPos = Find('data-stat="mp" >240</td><td class="right " data-stat="fg" >','#mypage#') >
...
<cfif FoundPos gt 0>
	...
	<cfset FoundPos = Find('data-stat="mp" >240</td><td class="right " data-stat="fg" >','#mypage#',#foundpos# + 1)>

	<cfset HomeTeamBoxscore = FoundPos>
	<cfset done = true>
<cfelse>
	<cfset FoundPos = Find('data-stat="mp" >265</td><td class="right " data-stat="fg" >','#mypage#') >
	<cfif FoundPos gt 0>
		<cfoutput> FoundPos is #FoundPos#</cfoutput>
		<cfset AwayTeamBoxscore = FoundPos>
		...
		<cfset FoundPos = Find('data-stat="mp" >265</td><td class="right " data-stat="fg" >','#mypage#',#foundpos# + 1)>

		<cfset HomeTeamBoxscore = FoundPos>	
		<cfset done = true>
	<cfelse>
		<cfset FoundPos = Find('data-stat="mp" >290</td><td class="right " data-stat="fg" >','#mypage#') >
		<cfif FoundPos gt 0>
			<cfoutput> FoundPos is #FoundPos#</cfoutput>
			<cfset AwayTeamBoxscore = FoundPos>
			...
			<cfset FoundPos = Find('data-stat="mp" >290</td><td class="right " data-stat="fg" >','#mypage#',#foundpos# + 1)>
...
<cfif not done>
	<cfabort showerror="Game not played in 2 OTS or less!">
</cfif>
...
#mins# <br>
		...
		Loaded data for the away team !<br>
<p>
...
#ps#
				...
				Loaded data for the hometeam!<br>
...
Skipping the loads...All are done!
