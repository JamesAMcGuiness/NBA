...
<tr>
	  ...
	  <td>Und Health ADV</td>
  	  <td>undrat</td>
  	  <td>favTeamHealthL7</td>	
	  <td>UndTeamHealthL7</td>
       <td>Rating</td>		
...
<cfoutput query="GetUnderdogRating">
	...
	<cfset Rating = 0>
	<cfset sysid = ''>
	<cfif UndRat ge 10 and undplayedyest is 'N' and (Undhealthl7 - favhealthl7 gt -3) and (#UndRat# + #spd# gt 19)>
		<cfset Rating = 6>
		<cfset sysid = 'SYS22L7'> 
	<cfelseif UndRat ge 10 and undplayedyest is 'N' and (Undhealthl7 - favhealthl7 gt -3) and (#UndRat# + #spd# gt 18)>
		<cfset Rating = 5> 
		<cfset sysid = 'SYS21L7'> 
	<cfelseif UndRat ge 10 and undplayedyest is 'N' and (Undhealthl7 - favhealthl7 gt -3) and (#UndRat# + #spd# gt 17) >
		<cfset Rating = 4>
		<cfset sysid = 'SYS19L7'> 
	<cfelseif UndRat ge 10 and undplayedyest is 'N' and (Undhealthl7 - favhealthl7 gt -3) and spd gt 3.5 >	
 		<cfset Rating = 3>
		<cfset sysid = 'SYS18L7'> 
	<cfelseif  UndRat ge 10 and undplayedyest is 'N' and (Undhealthl7 - favhealthl7 gt -3) and spd gt 1.5>
		 <cfset Rating = 2>
 		<cfset sysid = 'SYS28L7'> 
	<cfelseif UndRat ge 10 and undplayedyest is 'N' and (Undhealthl7 - favhealthl7 gt -3)>	
		 <cfset Rating = 1>
 		<cfset sysid = 'SYS27L7'> 
	</cfif>
...
<cfquery datasource="Nba" name="UPDATE">
	...
	values
	(
	'Did TopUnderDogPlaysLast7Health.cfm'
	)
</cfquery>
