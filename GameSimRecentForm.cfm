...
<cfset StartNum = 0>
<cfset EndNum = 0>
<cfset myGameTime='20070227'>	
<cfset Session.GameTime = mygametime>
		
<cfinclude template="CreateAvgsRecentForm.cfm">		
...
Select Avg(gsun.ouRating) as aRating, count(gsun.oupick),Avg(gsun. as Wins
